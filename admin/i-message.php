...
<body id="<?php echo $id ?>">
	...
	<section class="main-table">
		<div class="head-table">
			<img src="../images/messages.png" id="icon-title">
			<h2>Data Pesan-pesan</h2>
		...
		<div class="table">
			<div class="tambah">
				...
				<a href="create.php" id="tambah">Tambah Baru</a>
				
			</div>
			<table border="1">
				<tr bgcolor="steelblue">
					<th width="50"><center>No
					<th width="270"><center>Nama
					<th width="120"><center>Email
					<!-- <th width="120"><center>Tanggal Lahir -->
					<!-- <th width="140"><center>Jenis Kelamin -->
					<!-- <th width="130"><center>Agama -->
					<th width="500"><center>Komentar
				...
				while ($show = mysqli_fetch_array($result)) {
					...
					<td align='center'>$show[komentar]</td>
					<td align='center'>$show[created_at]</td>
					<td align='center'>$show[updated_at]</td>

					<td align='center'><a href='' id='show'>Lihat</a></td>
					<td align='center'><a href='' id='edit'>Ubah</a></td>
					<td align='center'><a href='' id='delete'>Hapus</a></td>
					</tr>
					";
					$no++;
				}
